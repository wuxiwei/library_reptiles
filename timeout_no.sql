...
--
-- Host: localhost
-- Generation Time: 2016-05-06 02:21:12
...
CREATE TABLE IF NOT EXISTS `timeout_no` (
...
--
-- Indexes for table `timeout_no`
--
ALTER TABLE `timeout_no`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `timeout_no`
--
ALTER TABLE `timeout_no`
